...
export default function CTA() {
  return (
    <section className="h-screen flex flex-col justify-center items-center relative overflow-hidden bg-orange-600 text-black">
      <div className="absolute inset-0 opacity-10 flex flex-col gap-10 select-none py-10 pointer-events-none">
        {[...Array(8)].map((_, i) => (
          <motion.div
            key={i}
      ...
      >
        <h2 className="text-[14vw] font-black uppercase leading-[0.7] tracking-tighter italic cursor-default">
          Launch<br />
        ...
        {/* WRAPPED IN LINK */}
        <Link href="/contact" className="mt-12 flex justify-center items-center gap-6 hover:scale-105 transition-transform duration-300">
